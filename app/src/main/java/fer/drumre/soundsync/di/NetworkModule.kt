package fer.drumre.soundsync.di
...
import fer.drumre.soundsync.domain.MusicRepositoryImpl
import fer.drumre.soundsync.domain.UserRepositoryImpl
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideKidsLingoApiService(retrofit: Retrofit): SoundSyncApi {
        return retrofit.create(SoundSyncApi::class.java)
    }
    ...
    @Provides
    @Singleton
    fun provideMusicRepository(api: SoundSyncApi): MusicRepository =
        MusicRepositoryImpl(api)

    @Provides
    @Singleton
    fun provideUserRepository(api: SoundSyncApi): UserRepository =
